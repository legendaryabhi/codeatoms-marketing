...
export const resourcesData: CategoryData[] = [
    {
        title: 'Strategies and resources for effective content marketing',
        slug: 'content-marketing',
        description: 'Learn how to create and distribute content that resonates with developers and drives engagement.',
        resources: [
            {
    ...
    {
        title: 'Developer Marketing Insights: Expert Strategies and Best Practices',
        slug: 'developer-marketing-insights',
        description: 'Learn how to gain valuable insights and strategies for marketing to developers from industry experts.',
        resources: [
            {
    ...
    {
        title: 'Social Media Marketing for Developer Tools: Complete Guide',
        slug: 'social-media-marketing',
        description: 'Learn how to reach and engage developers through social media platforms and tools.',
        resources: [
            {
    ...
    {
        title: 'Email Marketing Strategies for Developers: Best Practices',
        slug: 'email-marketing',
        description: 'Learn how to create effective email campaigns that resonate with developers and drive engagement.',
        resources: [
            {
    ...
    {
        title: 'SEO Best Practices for Developer Tools: Technical SEO Guide',
        slug: 'seo-for-developers',
        description: 'Learn how to improve search visibility and rankings for developer tools and resources.',
        resources: [
            {
    ...
    {
        title: 'Building Developer Communities: Strategies and Growth Tactics',
        slug: 'community-building',
        description: 'Learn how to create and nurture developer communities that drive engagement and growth.',
        resources: [
            {
    ...
    {
        title: 'Developer Marketing Analytics: Key Metrics and KPIs',
        slug: 'analytics-and-metrics',
        description: 'Learn how to measure developer engagement and product success using effective analytics and metrics.',
        resources: [
            {
    ...
    {
        title: 'Product Hunt Launch Guide for Developer Tools: Success Strategies',
        slug: 'product-hunt-launch-strategies',
        description: 'Learn how to successfully launch developer tools on Product Hunt and maximize visibility.',
        resources: [
            {
    ...
    {
        title: 'Developer Relations (DevRel): Complete Guide and Best Practices',
        slug: 'developer-relations',
        description: 'Learn how to build effective developer relations programs and advocacy initiatives.',
        resources: [
            {
    ...
    {
        title: 'Technical Writing Guide for Developer Tools: Documentation Best Practices',
        slug: 'technical-writing',
        description: 'Learn how to create effective technical documentation and content that resonates with developers.',
        resources: [
            {
    ...
    {
        title: 'API Documentation Best Practices: Tools and Strategies',
        slug: 'api-documentation',
        description: 'Learn how to create clear and useful API documentation that helps developers integrate with your tools.',
        resources: [
            {
    ...
    {
        title: 'Marketing Open Source Projects: Complete Guide for Developers',
        slug: 'open-source-marketing',
        description: 'Learn how to effectively market open source projects and tools to reach a wider developer audience.',
        resources: [
            {
    ...
    {
        title: 'Developer Podcast Marketing: How to Launch and Grow Your Show',
        slug: 'podcast-marketing',
        description: 'Learn how to create and promote developer-focused podcasts that engage and grow your audience.',
        resources: [
            {
    ...
    {
        title: 'Developer Experience (DX) Design: Principles and Best Practices',
        slug: 'developer-experience',
        description: 'Learn how to create excellent developer experiences that drive adoption and satisfaction.',
        resources: [
            {
    ...
    {
        title: 'How to Build Thriving Developer Communities: Growth Strategies',
        slug: 'developer-community-building',
        description: 'Learn how to build and nurture developer communities that create lasting value and engagement.',
        resources: [
            {
    ...
    {
        title: 'Essential DevRel Resources: Newsletters, Guides, and Communities',
        slug: 'devrel-resources',
        description: 'Learn how to stay updated on developer relations through curated resources and newsletters.',
        resources: [
            {
                title: "DevRel Weekly",
    ...
    {
        title: 'Measuring DevRel Success: KPIs, Metrics, and Analytics',
        slug: 'devrel-metrics',
        description: 'Learn how to measure the success of Developer Relations programs using effective metrics and KPIs.',
        resources: [
            {
    ...
    {
        title: 'Public Company Handbooks: Developer Marketing Strategies from Top Tech Companies',
        slug: 'company-handbooks',
        description: 'Learn from public handbooks and strategies from tech companies on developer marketing and growth.',
        resources: [
            {
